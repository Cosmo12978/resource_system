...
local pos = self:GetPos() + ang:Right() * -20 + ang:Up() * 21 + ang:Forward() * 0
...
cam.Start3D2D(pos,ang,0.1)
	...
	draw.SimpleText( "Atherium: ".. self:Getatheriumamounts().." /12", "Unarrest Npc Font", 160, 80, Color(255, 255, 255), 1, 1 ) 
