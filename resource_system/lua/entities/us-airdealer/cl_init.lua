...
net.Receive( "Operationirongate.USAirDealer", function()
...
title:SetText("Air Vehicle Dealer")
...
car1img:SetImage("entities/lunasflightschool_rebelheli.png")
...
car1button.DoClick = function()				
			net.Start("Operationirongate.USAirDealerPurchese")
            net.WriteInt(1,32)
            net.SendToServer()
end
