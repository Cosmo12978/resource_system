...
playerholder:SetRunSpeed(70)
playerholder:SetSlowWalkSpeed(70)
playerholder:SelectWeapon( "box_swep" )
end
...
function SWEP:SecondaryAttack()
	...
	function SWEP:dropcrate1 ()
		if (!SERVER) then return end; 

	local ent = ents.Create ("cargo_box");
	ent:SetPos (self.Owner:EyePos() + (self.Owner:GetAimVector() * 16));
	ent:SetAngles (self.Owner:EyeAngles());
	ent:Spawn()
	ent:Setcargoamounts(1)
	self:GetOwner():StripWeapon( "box_swep" )
